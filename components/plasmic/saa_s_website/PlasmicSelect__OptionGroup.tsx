...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: BcDghBKUvtnFbE/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: uV_rQKTqIoF0w_/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__va2Gv)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__j4IFi)}
              />
            </React.Fragment>
          ),
          value: args.children
