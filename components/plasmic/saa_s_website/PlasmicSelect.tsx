...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: tgn6Oypls3KsRB/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: uV_rQKTqIoF0w_/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: iWJD6KqRbqDjod/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: qjoTO4yh3AKMoq/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__ujuZ)}
    ...
    props = {
      ...
      children: (
        <React.Fragment>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__nl9PK)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
