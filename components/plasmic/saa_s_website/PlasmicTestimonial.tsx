...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: tvWizp6ssEsgQ/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__r2OVi)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__oBpA)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column___1Zl38)}>
            <h5
